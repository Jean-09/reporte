...
export interface ApiEdificioEdificio extends Struct.CollectionTypeSchema {
...
export interface ApiHistorialAccioneHistorialAccione
  extends Struct.CollectionTypeSchema {
  collectionName: 'historial_acciones';
  info: {
    displayName: 'historial-accione';
    pluralName: 'historial-acciones';
    singularName: 'historial-accione';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    accion: Schema.Attribute.Enumeration<
      ['creacion', 'aceptacion', 'inicio_trabajo', 'resolucion', 'cierre']
    > &
      Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
    ...
    fechaAccion: Schema.Attribute.DateTime & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::historial-accione.historial-accione'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    reporte: Schema.Attribute.Relation<'manyToOne', 'api::reporte.reporte'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    user: Schema.Attribute.Relation<
...
export interface ApiReporteReporte extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    archivosAdjuntos: Schema.Attribute.Media<'images' | 'files', true> &
      Schema.Attribute.Required;
    ...
    fechaAceptacion: Schema.Attribute.DateTime;
    fechaIncidente: Schema.Attribute.DateTime & Schema.Attribute.Required;
    fechaResolucion: Schema.Attribute.DateTime;
    historial_acciones: Schema.Attribute.Relation<
      'oneToMany',
      'api::historial-accione.historial-accione'
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    departamento: Schema.Attribute.Relation<
      ...
      'api::departamento.departamento'
    >;
    edificio: Schema.Attribute.Relation<'oneToOne', 'api::edificio.edificio'>;
    email: Schema.Attribute.Email &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMaxLength<{
        minLength: 6;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::historial-accione.historial-accione': ApiHistorialAccioneHistorialAccione;
